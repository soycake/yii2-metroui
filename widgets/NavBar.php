 ...
 * or [[\creators\metroui\widgets\Menu]] to build up such content. For example,
 *
 * ```php
 * use creators\metroui\widgets\NavBar;
 * use creators\metroui\widgets\Menu;
 *
 ...
 * @since 1.0
 */
class NavBar extends \creators\metroui\base\Widget
{
    /**
